    ...
    const allMachines: Machine[] = [
        ...
        },
        {
            ...
            hacks: [
                ...
                { name: "Trojan(Intercept)", description: "Increases accuracy against nearby MAIN.C-controlled bot by 15% for all friendly bots.", baseChance: 50, indirect: Indirect.Always, spoilerLevel: "Spoiler" },
        ...
        },
        {
            ...
            hacks: [
                ...
                { name: "Access(Emergency)", description: "Locate all nearby hidden doors. Also locates all phase walls if inside a Garrison.", baseChance: 60, indirect: Indirect.Sometimes },
                ...
                { name: "Download(Navigation)", description: "Obtain protocols for extracting patrol squad routing information throughout the connected Complex 0b10 area.", baseChance: 25, indirect: Indirect.Sometimes },
                { name: "Download(Registry)", description: "Access Garrison records to reveal its layout, security positions, and the locations of all registered components.", baseChance: 30, indirect: Indirect.Sometimes },
                { name: "Download(Security)", description: "Learn all active security positions throughout the connected Complex 0b10 area.", baseChance: 20, indirect: Indirect.Sometimes },
                ...
                { name: "Force(Override)", description: "Reveals location of all exits in a Garrison and overrides the lockdown effect that prevents Cogmind from leaving the map. Does nothing if outside a Garrison.", baseChance: 40, indirect: Indirect.Always, spoilerLevel: "Spoiler" },
