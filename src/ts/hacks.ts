    ...
    const allMachines: Machine[] = [
        {
            ...
            hacks: [
                ...
                { name: "Force(Download)", baseChance: 80, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Force(Overload)", baseChance: 80, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Load([Part Name])", baseChance: 90, indirect: Indirect.Never },
                { name: "Network(Status)", baseChance: 90, indirect: Indirect.Never },
                { name: "Trojan(Haulers)", baseChance: 50, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Prioritize)", baseChance: 30, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Report)", baseChance: 80, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Siphon)", baseChance: 50, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
            ],
        },
        {
            name: "Garrison",
            ...
            hacks: [
                ...
                { name: "Force(Eject)", baseChance: 80, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Force(Jam)", baseChance: 80, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Seal", baseChance: 30, indirect: Indirect.Never },
                { name: "Trojan(Broadcast)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Decoy)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Intercept)", baseChance: 50, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Redirect)", baseChance: 30, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Reprogram)", baseChance: 20, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Restock)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Watchers)", baseChance: 50, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
        ...
        },
        {
            ...
            dataCoreApplies: false,
            hacks: [
                { name: "Force(Tunnel)", baseChance: 80, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                ...
                { name: "Recycling(Process)", baseChance: 80, indirect: Indirect.Never },
                { name: "Trojan(Mask)", baseChance: 40, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Monitor)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Recyclers)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Reject)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
            ],
        },
        {
            name: "Repair Station",
            ...
            hacks: [
                ...
                { name: "Trojan(Mechanics)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
            ],
        },
        {
            name: "Scanalyzer",
            ...
            hacks: [
                ...
                { name: "Trojan(Researchers)", baseChance: 50, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
            ],
        },
        {
            name: "Terminal",
            ...
            hacks: [
                ...
                { name: "Control(Protovariants)", baseChance: 60, indirect: Indirect.Sometimes, spoilerLevel: "Spoilers" },
                ...
                { name: "Force(Sabotage)", baseChance: 60, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Force(Search)", baseChance: 80, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                ...
                { name: "Traps(Disarm)", baseChance: 45, indirect: Indirect.Sometimes },
                { name: "Trojan(Assimilate)", baseChance: 40, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Botnet)", baseChance: 50, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Detonate)", baseChance: 20, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Disrupt)", baseChance: 30, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Operators)", baseChance: 40, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
                { name: "Trojan(Track)", baseChance: 70, indirect: Indirect.Always, spoilerLevel: "Spoilers" },
            ],
        },
        {
            name: "Terminal - Door",
            dataCoreApplies: false,
            hacks: [
                { name: "Open - Access surface exit", baseChance: 7, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Spoilers" },
                { name: "Open - Access Command backdoors", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
                { name: "Open - Command Main.C door", baseChance: 60, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
                { name: "Open - Command prototype cache", baseChance: 10, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
                { name: "Open - Extension A7 cell", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Spoilers" },
                { name: "Open - Extension derelict cell", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Spoilers" },
                { name: "Open - Factory Extension exit", baseChance: 60, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Spoilers" },
                { name: "Open - Quarantine Sigix Terminator vault", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Spoilers" },
                { name: "Open - Quarantine Sigix Warrior chamber", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Spoilers" },
                { name: "Open - Research Quarantine exit", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Spoilers" },
                { name: "Open - Section 7 L2 lab backdoor", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
                { name: "Open - Section 7 LRC cache", baseChance: 60, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
                { name: "Open - Section 7 Terrabomb vault", baseChance: 60, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
                { name: "Open - Section 7 TR vault", baseChance: 60, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
                { name: "Open - Section 7 Matter Drive vault", baseChance: 30, indirect: Indirect.Never, level1DirectOnly: true, spoilerLevel: "Redacted" },
