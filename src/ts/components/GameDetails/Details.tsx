...
export const TooltipTexts = {
    ...
    Criticals:
        "Immune to all critical strike effects, and the core exposure effects of Core Analyzers and piercing damage.",
    Dismemberment:
    ...
    "High Siege":
        "Entering or exiting siege mode requires 7 turns. During the transition, and for as long as the mode is active, Cogmind is immobile and the treads cannot be disabled or removed. While in siege mode, non-melee attacks have +15% accuracy, coverage for all armor and heavy treads is doubled, any treads in siege mode get a free 25% damage reduction, no weapons suffer from recoil effects, and Cogmind is immune to instant part destruction from critical hits. Treads capable of High siege mode instead give +25% accuracy and have 50% damage resist.",
    Siege: "Entering or exiting siege mode requires 7 turns. During the transition, and for as long as the mode is active, Cogmind is immobile and the treads cannot be disabled or removed. While in siege mode, non-melee attacks have +15% accuracy, coverage for all armor and heavy treads is doubled, any treads in siege mode get a free 25% damage reduction, no weapons suffer from recoil effects, and Cogmind is immune to instant part destruction from critical hits. Treads capable of High siege mode instead give +25% accuracy and have 50% damage resist.",
    Martial:
...
export function DetailsItemTitleLine({ part }: { part: Item }) {
    ...
    if (part.specialTrait !== undefined) {
        const result = extraNumRegex.exec(part.specialTrait);
        if (result !== null) {
